...
export default function Receipe() {
    ...
    const buttonclick = (name) => {
        ...
        const additem = receipee.filter((cat) => {
            if (name === "All") {
                return receipee;
            }
            else if (cat.category === name[0].toUpperCase() + name.slice(1).toLowerCase()) {
                return receipee;
            }
    ...
    return (
        <Header>
            <div style={{ backgroundColor: cool ? "white" : "black" }}>
                <div className="caro" style={{ position: 'absolute', top: "0", left: "0", zIndex: "-1", opacity: "0.866" }}>
                    ...
                    <Carousel showThumbs={false} autoPlay={true} transitionTime={5} infiniteLoop={true} showStatus={false}  >
                        <div>
                            ...
                            <p className="p " style={{ position: "absolute", color: "#E1EBEE", top: "50%", left: "900px", fontSize: "80px", fontWeight: "bold", opacity: "1" }}>Our Receipe</p>
                        </div>
                        <div>
                            <img className="img" src={our2} alt='picture' style={{ width: "100%", height: "1120px" }} />
                            <p className="p" style={{ position: "absolute", color: "#E1EBEE", top: "50%", fontSize: "80px", fontWeight: "bold", left: "900px", zIndex: "2", opacity: "2" }}>Our Receipe</p>


                        </div>
                        <div>
                            <img className="img" src={our3} alt='picture' style={{ width: "100%", height: "1120px" }} />
                            <p className="p" style={{ position: "absolute", color: "#E1EBEE", top: "50%", fontSize: "80px", fontWeight: "bold", left: "900px", opacity: "1" }}>Our Receipe</p>
                ...
                <div className='main' style={{ marginTop: "965px",height:"1120px",width:"100%" }}>
                    <div className='query'>
                        <div id="searching"  >
                                ...
                                .map((index, i) => {
                                    return (
                                        <div key={i} style={{ color: "black", background: "white" }} className="card">
                                            <img src={index.imageUrl} alt="Avatar" style={{ width: "100%", height: "350px" }} />
                                            <div className="containerr">
                                                <h4 style={{fontSize:""}}><b>{index.title}</b></h4>
                                                <button className="buttonvai"><Link className="Navlink" style={{ textDecoration: "none" }} to={`/courses/${index.id}/${index.slug}`}  > View Pages</Link></button>
                                            </div>
                                        </div>
                                    )
                                })}
